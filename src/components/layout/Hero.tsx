...
const Hero: React.FC = () => {
    return (
        <div className=" flex items-center flex-col justify-between bg-hero-pattern h-screen">
            <nav className=" hidden m-auto w-full xl:flex xl:items-center xl:justify-around xl:flex-wrap xl:h-32">
            ...
            <div className=" flex flex-col w-4/5 xl:w-3/5 m-auto gap-10">
                ...
                <p className=" font-montserrat items-end justify-center text-center font-bold not-italic text-6xl xl:text-8xl text-shadow-counter text-black ">22d 13h 46m 18s</p>
            </div>
        </div>
    );
};
